...
})({"dn28c":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d9dbdf144f84273b";
...
function controlLanguage() {
    ...
    _contactViewJsDefault.default.renderContact(_modelJs.language.language).then((res)=>{
        return _helperJs.addListeners(validarFormulario, enviarEmail, captchaValidar);
    });
    return true;
}
const mensajes = {
...
async function init() {
    ...
    _helperJs.addListeners(validarFormulario);
}
init().then((res)=>{
...
},{"./model.js":"dkYPG","./view/aboutView.js":"eaY21","./view/habilitiesView.js":"1wl9p","./view/workView.js":"kRFnn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/contactView.js":"f0gp0","./helper.js":"eEkTv"}],"dkYPG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../../../images/icons.svg":"3Nvlv","../../language.json":"awwat","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Nvlv":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('iHEM4') + "icons.023d1b17.svg" + "?" + Date.now();
...
},{"./view.js":"eF7YH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../language.json":"awwat"}],"eEkTv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addListeners", ()=>addListeners
);
function addListeners(validarFormulario, enviarEmail, captchaValidar) {
    return new Promise((resolve, reject)=>{
        //window.addEventListener("load", function(event) {
        resolve(document.querySelector('#name').addEventListener('blur', validarFormulario), document.querySelector('#email').addEventListener('blur', validarFormulario), document.querySelector('#subject').addEventListener('blur', validarFormulario), document.querySelector('#message').addEventListener('blur', validarFormulario), document.querySelector('form').addEventListener('submit', enviarEmail));
    //  })
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dn28c","2dUup"], "2dUup", "parcelRequiree9aa")

//# sourceMappingURL=index.4f84273b.js.map
